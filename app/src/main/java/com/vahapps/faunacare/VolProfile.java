...
public class VolProfile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VolProfile.this, "Updated Profile", Toast.LENGTH_LONG).show();
    ...
    public void getData() {
        ...
        fref.addChildEventListener(new ChildEventListener() {
            ...
            @Override
            public void onChildAdded(DataSnapshot d, String s) {
                Log.d("inchild",d.child("volId").getValue().toString());
                Fauna upload = d.getValue(Fauna.class);
                if (uid.equals(d.child("volId").getValue().toString())) {
                    uploads.add(upload);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_upload) {
            Intent i = new Intent(VolProfile.this, UploadFaunaDetails.class);
            startActivity(i);
            // Handle the camera action
        } else if (id == R.id.nav_fauna) {
            Intent i = new Intent(VolProfile.this, FaunasInNeed.class);
            startActivity(i);
        } else if (id == R.id.nav_home) {
            Intent i = new Intent(VolProfile.this, Home.class);
            i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
        } else if (id == R.id.nav_logout) {
            mAuth.signOut();
            Intent i = new Intent(VolProfile.this, MainActivity.class);
            i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(i);
            finish();
        } else if (id == R.id.nav_allVets) {
            Intent i = new Intent(VolProfile.this, AllVet.class);
            startActivity(i);
        } else if (id == R.id.nav_myProfile) {
        } else if (id == R.id.nav_tips) {
            Intent i =new Intent(VolProfile.this,Tips.class);
            startActivity(i);
        }
